...
/**
 * @typedef {Object} CsdsResponse
 * @property {{service: string, account: string, baseURI: string}[]} baseURIs
 */

/**
 * @typedef {Object} UsersAPIResponse
 * @property {string} nickname
 */

/**
 * @typedef {Object} Domains
 * @property {string} acCdnDomain
 * @property {string} asyncMessagingEnt
 * @property {string} idp
 * @property {string} msgHist
 * @property {string} sentinel
 * @property {string} swiftDomain
 */